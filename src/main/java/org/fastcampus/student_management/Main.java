...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CourseQueryRepository courseQueryRepository = new CourseJdbcQueryRepository();
    ...
    StudentInfoDto studentInfoDto1 = new StudentInfoDto("김구", 21, "서울시 노원구");
    ...
    CourseInfoDto courseInfoDto1 = new CourseInfoDto("첼로", 1200, "MONDAY", "김구", 1717299008L);
